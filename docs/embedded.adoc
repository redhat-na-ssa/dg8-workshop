...
----
sh $PROJECTS_ROOT/dg8-workshop-labs/dg8-embedded-quarkus/scripts/load.sh
----

Reload *PREVIEW* again in Dev Spaces workspaces and you will see some scores updated. Now these scores were posted directly:
