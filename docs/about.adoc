...
This workshop is a BYOB (Bring Your Own Browser) session. You will be provided with a CodeReady Workspace, an Openshift environment with all pre-provisioned. If you prefer to run locally on your laptop, you can do development on your laptop. Just keep in mind that all instructions are designed to run with Dev Spaces workspaces i.e. browser-based. If you decide to run locally on your laptop you need JDK 11 and Apache Maven (3.5+).
