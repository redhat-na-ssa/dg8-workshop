...
Back in {{ CHE_URL }}[Dev Spaces Workspaces^], navigate to the project `infinispan-server-tutorial`. This is a template project, and you will be writing code into this project.
