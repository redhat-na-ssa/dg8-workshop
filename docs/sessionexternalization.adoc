...
image::devspaces-embedded-cache-project.png[embeddedCache, 700, align="center"]
...
image::embedded-cache-endpoints.png[endpoints, align="center"]

Click on the `Copy URL` button of the `instace1` endpoint. Paste on a new browser tab.

image::embedded-cache-app-1.png[app1, 700]
...
image::embedded-cache-app-2.png[app2, 700]
...
image::embedded-cache-app-3.png[app3, 700]
