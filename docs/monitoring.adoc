...
For this, head off to your Dev Spaces workspace Terminal and run the following command. Ensure that you are already logged in to Openshift via the terminal and that your project is `{{ USER_ID }}-cache`.
