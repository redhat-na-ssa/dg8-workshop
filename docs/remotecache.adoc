...
Back in {{ CHE_URL }}[Dev Spaces^], navigate to the project `dg8-quarkus-client-example`. This is a template project, and you will be writing code into it.
...
[source, shell, role="copypaste"]
----
mvn clean package -DskipTests -f $PROJECTS_ROOT/dg8-workshop-labs/dg8-quarkus-client-example
----
